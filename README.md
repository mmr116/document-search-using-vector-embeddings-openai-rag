# An application to generate vector embeddings for PDF documents, store them in a vector database, and enable semantic search and information retrieval using OpenAI's language models.
